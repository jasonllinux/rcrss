...
/**
 * Police office communication center
 */
public class PoliceCenter extends StandardAgent<PoliceOffice> {
	...
	public PoliceCenter() {
		super();
		System.out.println("Police Center " + AgentsConnectedCounter++
				+ " Created!");
	}

	@Override
	public String toString() {
		return "Police office communication centre";
	}
	...
	protected void think(int time, ChangeSet changed, Collection<Command> heard) {
		...
		for (Building b : burningBuildings) {
			if (!reportedBurningBuildings.contains(b.getID())) {
				...
				System.out.println("Police Center says: Building on Fire");
			}
		}
		...
		for (Building b : collapsedBuildings) {
			if (!reportedCollapsedBuildings.contains(b.getID())) {
				...
				System.out.println("Police Center says: Collapsed Building");
			}
		}
		...
		for (Human h : buriedHumans) {
			if (!reportedBuriedHumans.contains(h.getID())) {
				...
				System.out.println("Police Center says: Buried Human");
			}
		}
	}
