...
public class StuckChecker {
    ...
    public StuckChecker(MrlWorld world, int stuckThreshold, int randomCount) {
...
//            }
    ...
    /**
     * This method determines weather the specified agent is clocked or not. For investigating the situation,<br/>
