 ...
 * </ul>
 *
 * @see mrl.common.clustering.FireClusterMembershipEstimator
 * @author Siavash
 */
public class FireClusterMembershipCheckerBasedOnEstimatedFieryness implements IClusterMembershipChecker {
    ...
    public boolean checkMembership(Object object) {
        ...
        if(object instanceof MrlBuilding){
            ...
            if( building.getSelfBuilding() != null
                    ...
                    && building.getEstimatedFieryness()>=1
