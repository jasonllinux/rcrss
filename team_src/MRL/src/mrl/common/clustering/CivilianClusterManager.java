...
import mrl.viewer.layers.MrlCivilianClusterLayer;
...
//            convexObjectsForViewer.add(cluster.getConvexHullObject());
//        }
//        MrlCivilianClusterLayer.BUILDING_VALUES.put(world.getSelf().getID(), convexObjectsForViewer);
//        java.util.List<Cluster> clusterList = new ArrayList<Cluster>();
//        clusterList.addAll(clusters);
        MrlCivilianClusterLayer.CONVEX_HULLS_MAP.put(world.getSelf().getID(), clusters);
    }
}
