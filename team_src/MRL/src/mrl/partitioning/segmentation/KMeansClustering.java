...
import mrl.viewer.layers.MrlKmeansLayer;
...
//        }
    ...
    private void layerPut(java.util.List<java.util.List<Point>> clusters) {
        MrlKmeansLayer.CENTER_POINTS.put(world.getSelf().getID(), clusterCenterPoints);
//        System.out.print("number : " + clusterCenterPoints.size());
        MrlKmeansLayer.COMMON_POINTS.put(world.getSelf().getID(), clusters);
    }
}
