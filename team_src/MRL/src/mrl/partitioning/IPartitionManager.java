...
public interface IPartitionManager {
    ...
    /**
     * Finds the partition among the specified {@code partitions} including the specified area.
     *
     * @param areaId ID of the Area (Road or Building) for which we need to find the partition
     * @return The partition which includes the specified area or {@code null} if no partition includes the specified area.
     */
