...
import mrl.assignment.HungarianAssignment;
...
import mrl.viewer.layers.MrlPoliceTargetClustersLayer;
...
public class PoliceTargetPartitionManager implements IPartitionManager {
    ...
    private Map<Human, List<Partition>> humanPartitionsMap;
    ...
    public PoliceTargetPartitionManager(MrlWorld world, PoliceForceUtilities utilities, ITargetManager targetManager) {
        ...
        this.humanPartitionsMap = new FastMap<Human, List<Partition>>();
...
//        this.assignmentMethod = new GreedyAssignment();
    ...
    private void updateViewer() {
        if (MRLConstants.LAUNCH_VIEWER) {
            ...
            MrlPoliceTargetClustersLayer.PARTITIONS_MAP.put(world.getSelf().getID(), getPartitions());
            MrlPoliceTargetClustersLayer.HUMAN_PARTITIONS_MAP.put(world.getSelf().getID(), humanPartitionsMap);
        }
