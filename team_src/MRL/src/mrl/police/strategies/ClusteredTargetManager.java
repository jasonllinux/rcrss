...
public class ClusteredTargetManager extends DefaultTargetManager {
    ...
    //StandardEntity of targets, not their positions
    private Set<StandardEntity> unDoneTargets;
    ...
    public Map<EntityID, Target> getTargets(Partition partition) {
        ...
        if (unDoneTargets == null) {
            unDoneTargets = new FastSet<StandardEntity>();
        ...
        if (unDoneTargets.isEmpty()) {
            ...
            for (StandardEntity entity : unDoneTargets) {
     ...
     */
    private void updateTargets(Set<StandardEntity> unDoneTargets) {

        unDoneTargets.removeAll(doneTargets);
