...
public class LegacyActionStrategy extends DefaultActionStrategy {
    ...
    public LegacyActionStrategy(MrlWorld world, ClearHelper clearHelper, PoliceMessageHelper policeMessageHelper, PoliceForceUtilities utilities, PoliceConditionChecker conditionChecker) {
