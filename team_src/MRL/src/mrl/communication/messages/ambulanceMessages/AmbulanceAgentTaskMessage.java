 ...
 * Time: 5:15 PM
 */
public class AmbulanceAgentTaskMessage extends Message {

    public AmbulanceAgentTaskMessage() {
        super();
    }

    public AmbulanceAgentTaskMessage(int agentID, int victimID) {
        this();
    ...
    public boolean equals(Message message) {
        if (!(message instanceof AmbulanceAgentTaskMessage)) {
            return false;
        }
        return (getAgentID() == ((AmbulanceAgentTaskMessage) message).getAgentID());
    }
