...
/**
 * This packet will sent, when any AT transporting any civilian
 */
public class TransportingCivilianMessage extends Message {

    public TransportingCivilianMessage() {
        super();
    }

    public TransportingCivilianMessage(int civilianId) {
        this();
    ...
    public MessageType getType() {
        return MessageType.TransportingCivilianMessage;
    }
    ...
    public boolean equals(Message message) {
        if (!(message instanceof TransportingCivilianMessage)) {
            return false;
        }
        return (getCivilianId() == ((TransportingCivilianMessage) message).getCivilianId());
    }
