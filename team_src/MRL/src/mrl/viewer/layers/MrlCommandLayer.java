...
//        g.setColor(new Color(a,b,c));
    ...
    private void renderClearArea(AKClearArea clear) {
        try {
            ...
            Polygon clearPolygon = Util.transformToScreen(Util.clearAreaRectangle(position.getX(), position.getY(), clear.getDestinationX(), clear.getDestinationY(), MrlHumanLayer.CLEAR_RADIUS),t);
