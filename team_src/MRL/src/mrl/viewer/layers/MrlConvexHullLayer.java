        ...
        if (StaticViewProperties.selectedObject != null) {
            try {
                ...
                if (CONVEX_HULLS_MAP.get(StaticViewProperties.selectedObject.getID()) != null) {
                    clusters = CONVEX_HULLS_MAP.get(StaticViewProperties.selectedObject.getID());
                }
...
*/
    ...
    private void RenderOthers(Graphics2D g, ScreenTransform t, Point centerPoint, ConvexObject convexObject) {
        ...
        if (convexObject.FIRST_POINT != null) {
            ...
            circle2D.draw(g);
            circle2D = new Circle2D(t.xToScreen(convexObject.CONVEX_POINT.x), t.yToScreen(convexObject.CONVEX_POINT.y), 10, true);
            circle2D.draw(g);
