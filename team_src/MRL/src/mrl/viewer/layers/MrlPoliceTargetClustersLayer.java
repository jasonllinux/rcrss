...
public class MrlPoliceTargetClustersLayer extends StandardViewLayer {
    ...
    public static Map<EntityID, java.util.List<Partition>> PARTITIONS_MAP = Collections.synchronizedMap(new FastMap<EntityID, java.util.List<Partition>>());
    public static Map<EntityID, Map<Human, List<Partition>>> HUMAN_PARTITIONS_MAP = Collections.synchronizedMap(new FastMap<EntityID, Map<Human, List<Partition>>>());
    ...
    public Collection<RenderedObject> render(Graphics2D g, ScreenTransform t, int width, int height) {
        ...
        java.util.List<Partition> partitions = null;

        Map<Human, List<Partition>> humanPartitionsMap = null;
...
//
    ...
    private void renderAssignment(Graphics2D g, ScreenTransform t, Map<Human, List<Partition>> humanPartitionsMap) {
        Color COLOUR;
        int sumX;
        int sumY;
