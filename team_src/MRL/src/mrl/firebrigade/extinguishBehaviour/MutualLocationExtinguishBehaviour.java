 ...
 */
public class MutualLocationExtinguishBehaviour implements IExtinguishBehaviour {
    @Override
...
//        moveToEntranceForCheck();
    ...
    private List<EntityID> getForbiddenLocations(MrlFireBrigadeWorld world, FireBrigadeTarget target) {
        ...
        if (MRLConstants.LAUNCH_VIEWER) {
            MrlForbiddenLocationsLayer.FORBIDDEN_LOCATIONS.put(world.getSelf().getID(), forbiddenLocations);
        }
