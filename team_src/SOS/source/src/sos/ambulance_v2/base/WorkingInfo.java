...
public class WorkingInfo {
	private Pair<Human, SOSIState> target = null;
	...
	public void setTarget(Human newTarget, SOSIState state) {
		...
		this.target = new Pair<Human, SOSIState>(newTarget, state);

	}

	private void clearTarget() {
		this.target = new Pair<Human, SOSIState>(null, null);
	}
