...
public class RescueInfo {
	public enum IgnoreReason {
		...
		, CenterAssignMoreImportantTarget, DeadHuman, FiryCivilian, InAmbulance, WillDie, StuckInUnreachableMode, IwasExtraAT, InvalidOldTarget, TargetLoadedByAnotherAT
	}
