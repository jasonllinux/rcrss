...
public final class GeometryTools2D {
	...
	/** @author nima */
	public static Point2D getIntersectionPoint(Edge edge1, Edge edge2) {
	 ...
	 *            The points to connect.
	 * @param close
	 *            Whether to close the shape or not.
	 * @return A list of Line2D objects.
	 */
	...
	public static double getDistance2(Point2D p1, Point2D p2) {
		double dx = p1.getX() - p2.getX();
		double dy = p1.getY() - p2.getY();
		return dx * dx + dy * dy;
	}
