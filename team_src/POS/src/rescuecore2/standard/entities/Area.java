...
public abstract class Area extends StandardEntity {
	...
	public boolean target4Trashy = false;
	private Shape shape;
	private int[] apexList;
	private List<EntityID> neighbours;
	// Poseidon Code
	public int lastTimeVisit = -1;
	public int lastTimeSeen = -1;
	public int realLastTimeSeen = -1;
	public worldGraph.Area worldGraphArea = null;
	public ArrayList<Road> nearRoads = new ArrayList<Road>();
	public ArrayList<Building> nearBuildings = new ArrayList<Building>();
	public ArrayList<Area> nearAreas50000 = new ArrayList<Area>();
	public int pathNum = -1;
	public boolean isNearFire = false;
	public boolean marked = false;
	public Area lastArea = null;
	public boolean check = false;
	public Road before = null;
	public boolean isneighbourOfBuilding = false;
	public boolean isOk = false;
	public int fgNum = -1;
	public int heardlastTimeSeen = -1;
	public boolean checkForAmbForBFS = false;
