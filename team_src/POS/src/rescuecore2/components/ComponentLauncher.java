...
public abstract class ComponentLauncher implements RequestIDGenerator {
    ...
    */
    ...
    public void connect(Component c, String fileName) throws InterruptedException, ConnectionException, ComponentConnectionException {
        Connection connection = makeConnection(fileName);
    ...
    */
    protected abstract Connection makeConnection(String fileName) throws ConnectionException;
}
